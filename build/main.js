...
var $author$project$Main$BulletC = function (a) {
	return {$: 'BulletC', a: a};
};
var $author$project$Main$ConfettiC = function (a) {
	return {$: 'ConfettiC', a: a};
};
var $author$project$Main$FireworkC = function (a) {
	return {$: 'FireworkC', a: a};
};
var $author$project$Main$Ooze = function (a) {
	return {$: 'Ooze', a: a};
};
...
var $author$project$Main$cursorDecode = function (cursor) {
	switch (cursor) {
		case 'Confetti':
			return $author$project$Main$ConfettiC(
				{height: 65, width: 65});
		case 'Bullet':
			return $author$project$Main$BulletC(
				{height: 85, width: 150});
		case 'Ooze':
			return $author$project$Main$Ooze(
				{height: 65, width: 65});
		case 'Firework':
			return $author$project$Main$FireworkC(
				{height: 65, width: 65});
		case 'Star':
			return $author$project$Main$StarC(
				{height: 65, width: 65});
		case 'Rain':
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			cursor: $author$project$Main$cursorDecode('Confetti'),
			mouse: _Utils_Tuple2(0, 0),
			systemBullet: $BrianHicks$elm_particle$Particle$System$init(
				$elm$random$Random$initialSeed(0)),
			systemConfetti: $BrianHicks$elm_particle$Particle$System$init(
				$elm$random$Random$initialSeed(0)),
			systemFirework: $BrianHicks$elm_particle$Particle$System$init(
				$elm$random$Random$initialSeed(0)),
			systemPuke: $BrianHicks$elm_particle$Particle$System$init(
				$elm$random$Random$initialSeed(0)),
...
var $author$project$Main$ChangeCursor = function (a) {
	return {$: 'ChangeCursor', a: a};
};
var $author$project$Main$MouseMove = F2(
	function (a, b) {
		return {$: 'MouseMove', a: a, b: b};
	});
var $author$project$Main$ParticleBulletMsg = function (a) {
	return {$: 'ParticleBulletMsg', a: a};
};
var $author$project$Main$ParticleConfettiMsg = function (a) {
	return {$: 'ParticleConfettiMsg', a: a};
};
var $author$project$Main$ParticleFireworkMsg = function (a) {
	return {$: 'ParticleFireworkMsg', a: a};
};
var $author$project$Main$ParticlePukeMsg = function (a) {
	return {$: 'ParticlePukeMsg', a: a};
};
...
var $author$project$Main$TriggerBurst = {$: 'TriggerBurst'};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$dimensionsReceiver = _Platform_incomingPort('dimensionsReceiver', $elm$json$Json$Decode$string);
...
var $author$project$Rain$Rain = function (a) {
	return {$: 'Rain', a: a};
};
...
var $author$project$Rain$droplet = A2(
	$elm$random$Random$map,
	$author$project$Rain$Rain,
	A2(
		$elm$random$Random$uniform,
		'#d8e3d7',
		_List_fromArray(
			['#9caca1', '#788781', '#586767', '#445053'])));
...
var $author$project$Rain$rainEmitter = F3(
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A3($BrianHicks$elm_particle$Particle$System$sub, _List_Nil, $author$project$Main$ParticleBulletMsg, model.systemBullet),
				A3($BrianHicks$elm_particle$Particle$System$sub, _List_Nil, $author$project$Main$ParticlePukeMsg, model.systemPuke),
				A3($BrianHicks$elm_particle$Particle$System$sub, _List_Nil, $author$project$Main$ParticleFireworkMsg, model.systemFirework),
				A3($BrianHicks$elm_particle$Particle$System$sub, _List_Nil, $author$project$Main$ParticleStarsMsg, model.systemStars),
				A3(
				$BrianHicks$elm_particle$Particle$System$sub,
				_List_fromArray(
					[
						A2($author$project$Rain$rainEmitter, model.window.width, model.window.height)
					]),
				...
				$author$project$Main$dimensionsReceiver($author$project$Main$Resize),
				$author$project$Main$messageReceiver($author$project$Main$ChangeCursor)
			]));
};
var $author$project$Main$TriggerSprouts = function (a) {
	return {$: 'TriggerSprouts', a: a};
};
...
var $author$project$Confetti$burst = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		$elm$random$Random$list,
...
var $author$project$Firework$particleAt = F3(
	function (color, x, y) {
		return A2(
			$BrianHicks$elm_particle$Particle$withDrag,
			function (_v0) {
...
var $author$project$Firework$burst = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	var _v1 = A2(
		$elm$random$Random$step,
		...
		$elm$random$Random$initialSeed(31415));
	var color = _v1.a;
	var seed = _v1.b;
	return A2(
		$elm$random$Random$list,
		100,
		A3($author$project$Firework$particleAt, color, x, y));
};
...
var $author$project$Puke$Blue = {$: 'Blue'};
var $author$project$Puke$Green = {$: 'Green'};
var $author$project$Puke$Orange = {$: 'Orange'};
var $author$project$Puke$Purple = {$: 'Purple'};
var $author$project$Puke$Red = {$: 'Red'};
var $author$project$Puke$Streamer = function (a) {
	return {$: 'Streamer', a: a};
};
var $author$project$Puke$Yellow = {$: 'Yellow'};
var $author$project$Puke$genStreamer = A3(
	$elm$random$Random$map2,
	F2(
		function (color, length) {
			return $author$project$Puke$Streamer(
				{
					color: color,
					length: $elm$core$Basics$round(
						$elm$core$Basics$abs(length))
	...
	A2(
		$elm$random$Random$uniform,
		$author$project$Puke$Red,
		_List_fromArray(
			[$author$project$Puke$Orange, $author$project$Puke$Yellow, $author$project$Puke$Green, $author$project$Puke$Blue, $author$project$Puke$Purple])),
	A2(
		$elm$random$Random$map,
		$elm$core$Basics$max(10),
		A2($elm_community$random_extra$Random$Float$normal, 25, 10)));
var $author$project$Puke$particleAt = F2(
	function (x, y) {
		return A2(
			$BrianHicks$elm_particle$Particle$withDrag,
			function (confetti) {
						...
						A2(
							...
							A2(
								...
								A2(
									$BrianHicks$elm_particle$Particle$withLifetime,
									A2($elm_community$random_extra$Random$Float$normal, 1.5, 0.25),
									$BrianHicks$elm_particle$Particle$init($author$project$Puke$genStreamer))))))));
	});
var $author$project$Puke$burst = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		$elm$random$Random$list,
		100,
		A2($author$project$Puke$particleAt, x, y));
};
var $author$project$Revolver$Bullet = {$: 'Bullet'};
var $author$project$Revolver$genBullet = A2(
	$elm$random$Random$map,
	function (_v0) {
		return $author$project$Revolver$Bullet;
	},
	A2($elm_community$random_extra$Random$Float$normal, 1, 1));
var $author$project$Revolver$particleAt = F2(
	function (x, y) {
		return A2(
			$BrianHicks$elm_particle$Particle$withDrag,
			function (_v0) {
				return {area: 1.0, coefficient: 0.029, density: 0.001226};
			},
			A2(
				$BrianHicks$elm_particle$Particle$withGravity,
				980,
				A2(
					$BrianHicks$elm_particle$Particle$withSpeed,
					$elm$random$Random$constant(3000),
					A2(
						$BrianHicks$elm_particle$Particle$withDirection,
						$elm$random$Random$constant(
						...
						A2(
							...
							A2(
								...
								$BrianHicks$elm_particle$Particle$init($author$project$Revolver$genBullet)))))));
	});
var $author$project$Revolver$burst = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		$elm$random$Random$list,
...
var $author$project$Stars$Red = {$: 'Red'};
...
var $author$project$Stars$Star = function (a) {
	return {$: 'Star', a: a};
};
var $author$project$Stars$fugaz = function (color) {
	return A2(
		$BrianHicks$elm_particle$Particle$withLifetime,
		A2($elm_community$random_extra$Random$Float$normal, 2, 0.5),
		A2(
			$BrianHicks$elm_particle$Particle$withSpeed,
			$elm$random$Random$constant(2000),
			A2(
				$BrianHicks$elm_particle$Particle$withDirection,
				A2(
					$elm$random$Random$map,
					$elm$core$Basics$degrees,
					A2($elm_community$random_extra$Random$Float$normal, 255, 5)),
				$BrianHicks$elm_particle$Particle$init(
					$elm$random$Random$constant(
						$author$project$Stars$Star(color))))));
};
var $author$project$Stars$fugazAt = F3(
	function (color, x, y) {
		return A2(
			$BrianHicks$elm_particle$Particle$withGravity,
			0,
			A2(
				...
				$elm$random$Random$constant(
					{x: x, y: y}),
				$author$project$Stars$fugaz(color)));
	});
...
var $author$project$Stars$burst = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		$elm$random$Random$andThen,
		function (len) {
			return A2(
				...
				A4(
					...
					$author$project$Stars$fugazAt,
					A2(
						$elm$random$Random$uniform,
						$author$project$Stars$Red,
						_List_fromArray(
							[$author$project$Stars$Green, $author$project$Stars$Blue])),
					A2($elm_community$random_extra$Random$Float$normal, x + 500, 100),
					A2($elm_community$random_extra$Random$Float$normal, y - 500, 100)));
		},
		A2($elm$random$Random$int, 1, 1));
};
var $author$project$Main$burst = function (model) {
	var _v0 = model.mouse;
	var x = _v0.a;
	var y = _v0.b;
...
var $author$project$Main$dimensionDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$Dimension,
	A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'height', $elm$json$Json$Decode$int));
var $author$project$Stars$star = function (color) {
	return A2(
		$BrianHicks$elm_particle$Particle$withLifetime,
		A2($elm_community$random_extra$Random$Float$normal, 40, 40),
		A2(
			$BrianHicks$elm_particle$Particle$withSpeed,
			A2(
				$elm$random$Random$map,
				A2($elm$core$Basics$clamp, 0, 10),
				A2($elm_community$random_extra$Random$Float$normal, 3, 1)),
			A2(
				$BrianHicks$elm_particle$Particle$withDirection,
				A2(
					$elm$random$Random$map,
					$elm$core$Basics$degrees,
					A2($elm_community$random_extra$Random$Float$normal, 310, 10)),
				$BrianHicks$elm_particle$Particle$init(
					$elm$random$Random$constant(
						$author$project$Stars$Star(color))))));
};
var $author$project$Stars$starAt = F3(
	function (color, x, y) {
		return A2(
			$BrianHicks$elm_particle$Particle$withGravity,
			0,
...
var $author$project$Stars$sprout = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	...
	return A2(
		...
		A4(
			$elm_community$random_extra$Random$Extra$andThen3,
			$author$project$Stars$starAt,
			A2(
				$elm$random$Random$uniform,
				$author$project$Stars$Red,
				_List_fromArray(
					[$author$project$Stars$Green, $author$project$Stars$Blue])),
			A2($elm_community$random_extra$Random$Float$normal, w / 2, w / 2),
			A2($elm_community$random_extra$Random$Float$normal, h / 2, h / 2)));
};
var $author$project$Main$sprout = function (model) {
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				case 'TriggerBurst':
					return _Utils_Tuple2(
						$author$project$Main$burst(model),
						$elm$core$Platform$Cmd$none);
				case 'TriggerSprouts':
					var amount = msg.a;
					if (amount > 0) {
						var $temp$msg = $author$project$Main$TriggerSprouts(amount - 1),
							$temp$model = $author$project$Main$sprout(model);
						msg = $temp$msg;
						model = $temp$model;
						continue update;
					} else {
						return _Utils_Tuple2(
							...
							A2(
								...
								20000,
								$author$project$Main$TriggerSprouts(1)));
					}
				case 'MouseMove':
					var x = msg.a;
					var y = msg.b;
				...
				case 'ParticleConfettiMsg':
					...
					return _Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$none);
				case 'ParticleBulletMsg':
					var particleMsg = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								systemBullet: A2($BrianHicks$elm_particle$Particle$System$update, particleMsg, model.systemBullet)
							}),
						$elm$core$Platform$Cmd$none);
				case 'ParticlePukeMsg':
					var particleMsg = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								systemPuke: A2($BrianHicks$elm_particle$Particle$System$update, particleMsg, model.systemPuke)
							}),
						$elm$core$Platform$Cmd$none);
				case 'ParticleFireworkMsg':
					var particleMsg = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								systemFirework: A2($BrianHicks$elm_particle$Particle$System$update, particleMsg, model.systemFirework)
							}),
						$elm$core$Platform$Cmd$none);
				case 'ParticleStarsMsg':
					var particleMsg = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								systemStars: A2($BrianHicks$elm_particle$Particle$System$update, particleMsg, model.systemStars)
							}),
						$elm$core$Platform$Cmd$none);
				case 'ParticleRainMsg':
					var particleMsg = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				case 'ChangeCursor':
					...
					if (cursorDec.$ === 'StarC') {
						var $temp$msg = $author$project$Main$TriggerSprouts(20),
				...
				default:
					var dimension = msg.a;
					var dimensionDecoded = A2($elm$json$Json$Decode$decodeString, $author$project$Main$dimensionDecoder, dimension);
					if (dimensionDecoded.$ === 'Ok') {
						var data = dimensionDecoded.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{window: data}),
...
var $author$project$Main$cursorDimensions = function (cursor) {
	switch (cursor.$) {
		case 'BulletC':
...
var $author$project$Main$cursorImage = function (cursor) {
	switch (cursor.$) {
		case 'ConfettiC':
			return '../assets/confeti/tada.png';
		case 'BulletC':
			return '../assets/gun/gun.png';
		case 'Ooze':
			return '../assets/puke/ooze.png';
		case 'FireworkC':
...
var $author$project$Confetti$view = function (particle) {
...
var $author$project$Firework$view = function (particle) {
	var _v0 = $BrianHicks$elm_particle$Particle$data(particle);
	var color = _v0.a;
...
var $author$project$Puke$fill = function (color) {
	switch (color.$) {
		case 'Red':
			return '#F60000';
		case 'Orange':
...
var $author$project$Puke$view = function (particle) {
	var lifetime = $BrianHicks$elm_particle$Particle$lifetimePercent(particle);
	var opacity = (lifetime < 0.1) ? (lifetime * 10) : 1;
	var _v0 = $BrianHicks$elm_particle$Particle$data(particle);
	var color = _v0.a.color;
	...
	var _v1 = A2(
		$elm$random$Random$step,
		A2($elm_community$random_extra$Random$Float$normal, leftPadding * 2, 2),
		$elm$random$Random$initialSeed(31415));
	var leftPaddingRand = _v1.a;
	var seed = _v1.b;
	return A2(
		$elm$svg$Svg$rect,
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$height('7px'),
				$elm$svg$Svg$Attributes$width(
				$elm$core$String$fromInt(length) + 'px'),
				$elm$svg$Svg$Attributes$y(
				$elm$core$String$fromFloat(-leftPaddingRand) + 'px'),
				$elm$svg$Svg$Attributes$rx('2px'),
				$elm$svg$Svg$Attributes$ry('2px'),
				$elm$svg$Svg$Attributes$fill(
				$author$project$Puke$fill(color)),
				$elm$svg$Svg$Attributes$opacity(
				$elm$core$String$fromFloat(opacity)),
				$elm$svg$Svg$Attributes$transform(
				'rotate(' + ($elm$core$String$fromFloat(
...
var $author$project$Rain$view = function (particle) {
	var length = A2(
		$elm$core$Basics$max,
		1,
		$BrianHicks$elm_particle$Particle$speed(particle) / 15);
...
var $author$project$Revolver$view = function (particle) {
	var lifetime = $BrianHicks$elm_particle$Particle$lifetimePercent(particle);
	var opacity = (lifetime < 0.1) ? (lifetime * 10) : 1;
	return A2(
		$elm$svg$Svg$path,
...
var $author$project$Stars$toHsl = function (color) {
	switch (color.$) {
		case 'Red':
			return _Utils_Tuple3(0, 86, 75);
		case 'Green':
...
var $author$project$Stars$view = function (particle) {
	var _v0 = $BrianHicks$elm_particle$Particle$data(particle);
	var color = _v0.a;
	var maxLuminance = 100;
	var lifetime = $BrianHicks$elm_particle$Particle$lifetimePercent(particle);
	...
	var length = A2(
		...
		1,
		$BrianHicks$elm_particle$Particle$speed(particle) / 15);
	var _v1 = $author$project$Stars$toHsl(color);
	var hue = _v1.a;
	var saturation = _v1.b;
	var luminance = _v1.c;
	var luminanceDelta = maxLuminance - luminance;
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$String$fromFloat(opacity)),
				$elm$svg$Svg$Attributes$fill(
				A3($author$project$Stars$hslString, hue, saturation, maxLuminance - (luminanceDelta * (1 - lifetime))))
			]),
		_List_Nil);
};
...
var $author$project$Main$view = function (model) {
	...
	var particleView = function () {
		...
		switch (_v2.$) {
			case 'ConfettiC':
				return A3($BrianHicks$elm_particle$Particle$System$view, $author$project$Confetti$view, props, model.systemConfetti);
			case 'BulletC':
				return A3($BrianHicks$elm_particle$Particle$System$view, $author$project$Revolver$view, props, model.systemBullet);
			case 'Ooze':
				return A3($BrianHicks$elm_particle$Particle$System$view, $author$project$Puke$view, props, model.systemPuke);
			case 'FireworkC':
	...
	var mouseX = _v0.a;
	var mouseY = _v0.b;
	var _v1 = $author$project$Main$cursorDimensions(model.cursor);
	var w = _v1.a;
	var h = _v1.b;
	return A2(
		$elm$html$Html$main_,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('myapp')
			]),
		_List_fromArray(
			[
				particleView,
				...
				_List_fromArray(
					[
						...
						$author$project$Main$cursorImage(model.cursor)),
						...
						A2($elm$html$Html$Attributes$style, 'cursor', 'none'),
						A2($elm$html$Html$Attributes$style, 'z-index', '170'),
