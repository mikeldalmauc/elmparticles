
{
  class AudioPlayer extends HTMLElement {
    ...
    barGap = 1;
    bufferPercentage = 75;
    nonAudioAttributes = new Set(['title', 'bar-width', 'bar-gap', 'buffer-percentage', 'image-src']);
    imageSrc = "";
      ...
      <style>
        ...
        * {
        ...
        .play-btn {
            ...
            min-width: 30px;
            height: 30px;
            background: url("../assets/audioplayer/audio-player-icon-sprite.png") 0 center/500% 100% no-repeat;
            appearance: none;
            border: none;
        ...
        .play-btn.playing {
            background: url("../assets/audioplayer/audio-player-icon-sprite.png") 25% center/500% 100% no-repeat;
        }
        ...
        .volume-bar {
            ...
            min-width: 30px;
            height: 30px;
            background: url("../assets/audioplayer/audio-player-icon-sprite.png") 50% center/500% 100% no-repeat;
            position: relative;
        }
        
        .volume-bar.half {
            background: url("../assets/audioplayer/audio-player-icon-sprite.png") 75% center/500% 100% no-repeat;
        }
        .volume-bar.over {
            background: url("../assets/audioplayer/audio-player-icon-sprite.png") 100% center/500% 100% no-repeat;
        }
      ...
      this.shadowRoot.innerHTML = `
       ${this.style()}
        <figure class="audio-player">
          <figcaption class="audio-name"><img src="${this.imageSrc}"></img></figcaption>
          ...
          <div class="progress-indicator">
              ...
              <canvas class="visualizer" style="width: 70%; height: 20px"></canvas>
          </div>
